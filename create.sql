...
create table IF NOT EXISTS PACIENTES(ID INT auto_increment PRIMARY KEY,NOMBRE VARCHAR(255),APELLIDO VARCHAR (255), DOMICILIO_ID INT, DNI INT, FECHA_ALTA TIMESTAMP WITHOUT TIME ZONE, TURNO_ID INT);
