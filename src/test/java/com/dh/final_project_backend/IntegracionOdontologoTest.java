...
import com.dh.final_project_backend.utils.Jsons;
...
public class IntegracionOdontologoTest {
    ...
    public void registrarOdontologo() throws Exception {
        Odontologo od = new Odontologo("Nua", "Valbuena", "1234");
        MvcResult response = this.mockMvc.perform(MockMvcRequestBuilders.post("/final/odontologos/post")
